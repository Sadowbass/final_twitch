...
public class BroadCastingAirVo {

	String air_mid;
	String air_subject;
	String air_content;
	String air_starttime;
	String air_gname;
	String air_tnames;
	String mem_skey;
	...
	public String getAir_starttime() {
		return air_starttime;
	}

	public void setAir_starttime(String air_starttime) {
		this.air_starttime = air_starttime;
	}
