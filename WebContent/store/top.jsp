            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        <li><a href="#" id="myPage" >My Page</a></li>
                        <li><a href="#" id="qna">Q & A</a></li>
                    </ul>
                </div>
                <!-- END TOP BAR MENU -->
            </div>
          ...
          <div class="top-cart-content-wrapper">
            <div class="top-cart-content">
              ...
              <div class="text-right">
                <a href="#;" onclick="store.viewCart()" class="btn btn-default">View Cart</a>
                <a href="#;"  onclick="store.checkout()"  class="btn btn-primary">Checkout</a>
              </div>
            </div>
          </div>            
        </div>
        ...
        <div class="header-navigation">
          <ul>
            ...
            <li class="dropdown">
              ...
              <!-- BEGIN DROPDOWN MENU -->
              <ul class="dropdown-menu">
                <li><a href="shop-product-list.html">Clothes</a></li>
                <li><a href="shop-product-list.html">The others</a></li>
              </ul>
              <!-- END DROPDOWN MENU -->
            </li>
