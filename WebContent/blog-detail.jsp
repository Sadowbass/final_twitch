            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card blog mb-4">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><a href="#">Aliquam euismod libero eu enim. Nulla nec felis sed
                                leo.</a></h5>
                            <div class="entry-meta">
                                <ul class="tag-info list-inline">
                                    <li class="list-inline-item"><a href="#"><i class="fas fa-calendar"></i> March 6,
                                        2020</a></li>
                                    <li class="list-inline-item"><i class="fas fa-folder"></i> <a rel="category tag"
                                                                                                  href="#">Image</a>
                                    </li>
                                    <li class="list-inline-item"><i class="fas fa-tag"></i> <a rel="tag"
                                                                                               href="#">envato</a>, <a
                                            rel="tag" href="#">sale</a>, <a rel="tag" href="#">shop</a></li>
                                    <li class="list-inline-item"><i class="fas fa-comment"></i> <a href="#">4
                                        Comments</a></li>
                                </ul>
                            </div>
                            <p>Aliquam convallis sollicitudin purus. Praesent aliquam, enim at fermentum mollis, ligula
                            ...
                            <p>Praesent aliquam, enim at fermentum mollis, ligula massa adipiscing nisl, ac euismod nibh
                                nisl eu lectus. Fusce vulputate sem at sapien. Vivamus leo. Aliquam euismod libero eu
                                enim. Nulla nec felis sed leo placerat imperdiet. Aenean suscipit nulla in justo.</p>
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus a nobis, vero in
                                corrupti nostrum. Magni reprehenderit tempora tempore maiores, repellat in laboriosam
                                aliquid ex error, iusto quae, et similique.</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis sunt a quam,
                                exercitationem, provident numquam quia eius optio quos vitae odio impedit ipsum
                                voluptatem earum neque architecto enim quisquam, ea.</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non, ipsum facilis, eaque
                                aliquid porro deleniti architecto eum perferendis quidem modi quo reiciendis dolor
                                deserunt beatae repellat, nostrum aut fuga. Rem?</p>
                    ...
                    <div class="card padding-card reviews-card mb-4">
                        <div class="card-body">
                            ...
                            <div class="media">
                                <img alt="" src="img/s1.png" class="d-flex mr-3 rounded">
                                <div class="media-body">
                                 ...
                                 <i class="fas fa-star-half text-warning"></i><small class="text-success">5/1</small>
                                    ...
                                    <div class="media mt-4">
                                        <img alt="" src="img/s3.png" class="d-flex mr-3 rounded">
                                        <div class="media-body">
                                            <h5 class="mt-0">Ryan Printz <small>Nov 13, 2020</small> <span
                                                    class="star-rating float-right">
                                       <i class="fas fa-star text-warning"></i>
                                       <i class="fas fa-star text-warning"></i>
                                       <i class="fas fa-star-half text-warning"></i>
                            ...
                            <div class="media mt-4">
                                <img alt="" src="img/s4.png" class="d-flex mr-3 rounded">
                                <div class="media-body">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card sidebar-card mb-4">
                        <div class="card-body">
                            ...
                            <ul class="sidebar-card-list">
                                ...
                                <li><a href="#"><i class="fas fa-chevron-right"></i> Uncategorized</a></li>
                    ...
                    <div class="card sidebar-card mb-4">
                        <div class="card-body">
                            ...
                            <ul class="sidebar-card-list">
                                <li><a href="#"><i class="fas fa-chevron-right"></i> December, 2017</a></li>
                                <li><a href="#"><i class="fas fa-chevron-right"></i> November, 2017</a></li>
                                <li><a href="#"><i class="fas fa-chevron-right"></i> October, 2017</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="card sidebar-card mb-4">
