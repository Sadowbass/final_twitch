                    ...
                    success: function (data,
                        ...
                        if (data != null) {
                            for (let i = 0; i < data.length; i++) {
                                ...
                                divCol1.appendChild(j);
                                divCol8.appendChild(divCol12);
                                divCol8.appendChild(divCol122);
                                let donationDiv = document.getElementById('donationDiv');
                                donationDiv.appendChild(divRow);
                                ...
                                if (data[i].type == '0') {
                                    ...
                                    toastr.success('룰렛후원이 도착하였습니다');
                                } else if (data[i].type == '3') {
                                    toastr.success('구독이 도착하였습니다');
                                }
                            }
                        }
                    }
