			...
			<div class="col-md-8">
				<div class="single-video-left">
					<div class="single-video-title box mb-3">
						<h2>
							<a href="#">Contrary to popular belief, Lorem Ipsum (2020) is not.</a>
						</h2>
						<p class="mb-0">
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade show active" id="retro-comments" role="tabpanel" aria-labelledby="retro-comments-tab">
								<div class="reviews-members pt-0">
									<div class="media">
										<a href="#">
											<img class="mr-3" src="img/s1.png" alt="Generic placeholder image">
										</a>
								...
								<div class="reviews-members">
									<div class="media">
										<a href="#">
											<img class="mr-3" src="img/s2.png" alt="Generic placeholder image">
										</a>
										<div class="media-body">
											<div class="reviews-members-header">
												<h6 class="mb-1">
													<a class="text-black" href="#">Gurdeep Osahan </a>
											...
											<div class="reviews-members-footer">
												...
												<span dir="rtl" class="total-like-user-main ml-2">
													<a href="#" title="Gurdeep Osahan" data-placement="top" data-toggle="tooltip">
														<img class="total-like-user" src="img/s1.png" alt="Generic placeholder image">
													</a>
													<a href="#" title="Gurdeep Osahan" data-placement="top" data-toggle="tooltip">
														<img class="total-like-user" src="img/s2.png" alt="Generic placeholder image">
													</a>
													<a href="#" title="Gurdeep Osahan" data-placement="top" data-toggle="tooltip">
														<img class="total-like-user" src="img/s3.png" alt="Generic placeholder image">
													</a>
													<a href="#" title="Gurdeep Osahan" data-placement="top" data-toggle="tooltip">
														<img class="total-like-user" src="img/s4.png" alt="Generic placeholder image">
													</a>
												</span>
											</div>
										</div>
								...
								<div class="reviews-members">
									<div class="media">
										<a href="#">
											<img alt="Generic placeholder image" src="img/s3.png" class="mr-3">
										</a>
										<div class="media-body">
											<div class="reviews-members-header">
												<h6 class="mb-1">
													<a href="#" class="text-black">Gurdeep Osahan </a>
													<small class="text-gray">2 months ago</small>
												</h6>
											</div>
											<div class="reviews-members-body">
											...
											<div class="reviews-members-footer">
												...
												<span class="total-like-user-main ml-2" dir="rtl">
													<a data-toggle="tooltip" data-placement="top" title="Gurdeep Osahan" href="#">
														<img alt="Generic placeholder image" src="img/s5.png" class="total-like-user">
													</a>
													<a data-toggle="tooltip" data-placement="top" title="Gurdeep Osahan" href="#">
														<img alt="Generic placeholder image" src="img/s6.png" class="total-like-user">
													</a>
													<a data-toggle="tooltip" data-placement="top" title="Gurdeep Osahan" href="#">
														<img alt="Generic placeholder image" src="img/s7.png" class="total-like-user">
													</a>
													<a data-toggle="tooltip" data-placement="top" title="Gurdeep Osahan" href="#">
														<img alt="Generic placeholder image" src="img/s8.png" class="total-like-user">
													</a>
												</span>
											</div>
										</div>
