                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="live_broadcast.jsp">생방송 관리</a>
                                    </li>
                                    <li>
                                        <a href="streamer.jsp">스트리머 관리</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="category_select.jsp">카테고리 조회</a>
                                    </li>
                                    <li>
                                        <a href="category_insert.jsp">카테고리 추가</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="advertise.jsp">광고 관리</a>
                                    </li>
                                    <li>
                                        <a href="subscribe_profit.jsp">구독 수익 관리</a>
                                    </li>
                                    <li>
                                        <a href="donation_profit.jsp">도네 수익 관리</a>
                                    </li>
                                </ul>
                            </li>
                      ...
                      <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="../tgd/board_select.jsp">게시판 조회</a>
                                    </li>
                                    <li>
                                        <a href="../tgd/streamerBoard_request.jsp">게시판 신청 관리</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="../tgd/menu_modify.jsp">메뉴 추가·삭제</a>
                                    </li>
                                    <li>
                                        <a href="../tgd/board_management.jsp">게시글 관리</a>
                                    </li>
                                    <li>
                                        <a href="../tgd/hotClip_management.jsp">핫클립 관리</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="../tgd/suggesion&report.jsp">건의/신고</a>
                                    </li>
                                    <li>
                                        <a href="../tgd/event.jsp">이벤트</a>
                                    </li>
                                    <li>
                                        <a href="../tgd/notice.jsp">공지사항</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="../tgd/advertise.jsp">
                                    <span>광고관리</span>
                                </a>
                            </li>
                            <li>
                                <a href="../tgd/statistic.jsp">
                                    <span>통계</span>
                                </a>
                            </li>
                        </ul>
