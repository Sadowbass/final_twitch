                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="home">
                                            ...
                                            <div class="panel-body">
                                                <div class="post">
                                                    <div class="post-heading">
                                                       <label>제목</label> <p>관심이 없는 추천 콘텐츠 삭제하기</p>
                                                    </div>
                                                    <div class="post-content">
                                                    
                                                     <div>
                                                       	  <iframe width="100%" height="700" src=https://developer.snapappointments.com/bootstrap-select/ frameborder="0" allowfullscreen=""></iframe>
                                                       	</div>
                                        ...
                                        <p>
                                            ...
                                            <button type="button" class="btn btn-defalt waves-effect m-r-20" id="help_modify_btn">수정</button> 
                                        </p>
                                    </div>
                                    </div>
                                </div>
