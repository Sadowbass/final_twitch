                                    ...
                                    <div class="panel-group" id="accordion_${i}" role="tablist"
                                        ...
                                        <div class="panel panel-primary">
                                            <div class="panel-heading" role="tab" id="headingOne_${i}">
                                                <h4 class="panel-title qa_title">
                                                    <a role="button" data-toggle="collapse"
                                                        data-parent="#accordion_${i}" href="#collapseOne_${i}"
                                            ...
                                            <div id="collapseOne_${i}" class="panel-collapse collapse in"
                                                role="tabpanel" aria-labelledby="headingOne_${i}">
                                            ...
                                            <div class="panel-heading" role="tab" id="headingTwo_${i}">
                                                <h4 class="panel-title qa_title">
                                                    <a class="collapsed" role="button" data-toggle="collapse"
                                                        data-parent="#accordion_${i }" href="#collapseTwo_${i }"
                                                        aria-expanded="false" aria-controls="collapseTwo_${i }">
                                                        Collapsible Group Item #2
                                                    </a>
                                                </h4>
                                            </div>
                                            <div id="collapseTwo_${i }" class="panel-collapse collapse" role="tabpanel"
                                        ...
                                        <div class="panel panel-primary">
                                            <div class="panel-heading" role="tab" id="headingThree_${i }">
                                                <h4 class="panel-title qa_title">
                                                    <a class="collapsed" role="button" data-toggle="collapse"
                                                        data-parent="#accordion_${i }" href="#collapseThree_${i }"
                                                        aria-expanded="false" aria-controls="collapseThree_${i }">
                                                        Collapsible Group Item #3
                                                    </a>
                                                </h4>
                                            </div>
                                            <div id="collapseThree_${i }" class="panel-collapse collapse"
                                                role="tabpanel" aria-labelledby="headingThree_${i }">
                                                <div class="panel-body">
                                                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
                                                    terry richardson ad squid. 3 wolf moon officia aute,
                                                    non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt
