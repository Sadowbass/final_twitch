							...
							<c:forEach var="i" begin="1" end="10">
								<div class="row">
									...
									<div class="col-xs-2" style="text-align: left;">
										<input type="text" class="form-control" value="상품명${i}" style="width:100px; float: left"></input><input type="button" class="btn" value="수정" style="margin-left: 30px;"/>
									</div>
									<div class="col-xs-1">
										<input type="text" class="form-control" value="10000" style="width:80px" >
									</div>
									<div class="col-xs-1">
										<input type="text" class="form-control" value="200" style="width:80px" >
									</div>
									<div class="col-xs-1">
										<select class="selectpicker form-control">
