                      ...
                      <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="product_select.jsp">상품조회</a>
                                    </li>
                                    <li>
                                        <a href="product_insert.jsp">상품추가</a>
                                    </li>
                                </ul>
                            ...
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="order_select.jsp">주문조회</a>
                                    </li>
                                    <li>
                                        <a href="order_treat.jsp">주문처리</a>
                                    </li>
                                </ul>
                            ...
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="customer_statistic.jsp">고객 통계</a>
                                    </li>
                                    <li>
                                        <a href="product_statistic.jsp">상품 통계</a>
                                    </li>
                                </ul>
