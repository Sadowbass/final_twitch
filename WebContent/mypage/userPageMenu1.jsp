						...
						<div class="card" style=''>
							...
							<div class="card-body col-sm-12">
								...
								<div class='col-sm-10' style='margin-top: 2%;text-align: left'>
									<button type="button" class="btn btn-outline-primary" id="saveProfill">프로필 사진변경</button>
									<p>10MB 이내의 JPEG, PNG, GIF 형식이어야 합니다.</p>
									<input type='file' id='userPhoto' name='userPhoto' style='display: none'>
								</div>
								</div>
							</div>
						</div>
								...
								<tbody>
									...
									<tr style="line-height: 32px;">
										...
										<td><input type="text" name="userName" id='userName'
											class="form-control" value="${vo.mem_name }" style=""></td>
									</tr>
									<tr style="line-height: 32px;">
										<td style="">이메일</td>
									...
									<tr style="line-height: 32px;">
										<td style="">자기소개</td>
										<td><textarea rows="" cols="" style="width: 100% !important;background-color: rgb(233,236,239)"
