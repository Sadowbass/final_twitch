                    ...
                    <div class="main-title">
                        <div class="btn-group float-right right-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a href="#" class="dropdown-item"><i class="fas fa-fw fa-times-circle"></i> &nbsp;
                                    Close</a>
                            </div>
                        </div>
                        <h6>Blog</h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="entry-meta">
                                <ul class="tag-info list-inline">
                                    <li class="list-inline-item"><a href="#"><i class="fas fa-calendar"></i> March
                                        6, 2020</a></li>
                                    ...
                                    <li class="list-inline-item"><i class="fas fa-tag"></i> <a rel="tag"
                                                                                               href="#">envato</a>,
                                        <a rel="tag" href="#">sale</a>, <a rel="tag" href="#">shop</a></li>
                                    <li class="list-inline-item"><i class="fas fa-comment"></i> <a href="#">4
                                        Comments</a></li>
                                </ul>
                            </div>
                            <p class="card-text">Aliquam convallis sollicitudin purus. Praesent aliquam, enim at
                                fermentum mollis, ligula massa adipiscing nisl, ac euismod nibh nisl eu lectus.
                                Fusce vulputate sem at sapien. Vivamus leo. Aliquam euismod libero eu enim. Nulla
                                nec felis sed leo placerat imperdiet. Aenean suscipit nulla in justo. Suspendisse
                                cursus rutrum augue. Nulla tincidunt tincidunt mi. Lorem ipsum dolor
                            </p>
                            <a href="#">READ MORE <span class="fas fa-chevron-right"></span></a>
                        </div>
                    </div>
                    <div class="card blog mb-4">
                        <div class="blog-header">
